...
const Annotation = ({ children, setChildren }) => {
  ...
  const shapesArray = [
    ...
    },
    {
      ...
      component: (
        <FiThumbsDown className="h-[100%] w-[100%]" style={{ color: color }} />
      ),
    },
    {
      name: 'Zap',
    ...
    },
    {
      ...
      component: (
        <FiHeadphones className="h-[100%] w-[100%]" style={{ color: color }} />
      ),
    },
    {
      name: 'Link',
    ...
    },
    {
      ...
      component: (
        <FiChevronsUp className="h-[100%] w-[100%]" style={{ color: color }} />
      ),
    },
    {
      name: 'Chevrons Left',
    ...
    },
    {
      ...
      component: (
        <FiArrowRight className="h-[100%] w-[100%]" style={{ color: color }} />
      ),
    },
    {
      name: 'Arrow Left',
        ...
        {shapesArray.map((shape, index) => (
          <Button
            onClick={() => {
              ...
              toast.success(`Added ${shape.name} Icon`);
            }}
            className="!m-1"
            key={index}
          >
            <Tooltip title={shape.name} arrow placement="bottom">
